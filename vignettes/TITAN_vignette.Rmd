...
![Elbow Plot](../data/Elbowplot_T47D_PEPE_SCE.png)
...
heatmap(T47D_SCE, SCE_topics, T47D_SCE@colData@listData$hash.ID, "Timepoint")

```

```{r}
SCE_FeaturePlot(T47D_SCE, pt.size = 0.01, topics = 1:8, ncol = 4, min.cutoff = 'q5')
SCE_FeaturePlot(T47D_SCE, pt.size = 0.01, topics = 9:16, ncol = 4, min.cutoff = 'q5')
SCE_FeaturePlot(T47D_SCE, pt.size = 0.01, topics = 17:20, ncol = 4, min.cutoff = 'q5')
